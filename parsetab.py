...
_lr_productions = [
  ...
  ('statement -> IF LPAREN expression RPAREN LBRACE statements RBRACE','statement',7,'p_statement_if_else','parser.py',15),
  ('statement -> IF LPAREN expression RPAREN LBRACE statements RBRACE ELSE LBRACE statements RBRACE','statement',11,'p_statement_if_else','parser.py',16),
  ('statements -> statement','statements',1,'p_statements','parser.py',27),
  ('statements -> statements statement','statements',2,'p_statements','parser.py',28),
  ('expression -> expression IGUALDAD expression','expression',3,'p_expression_logic','parser.py',35),
  ('expression -> expression NEGACION expression','expression',3,'p_expression_logic','parser.py',36),
  ('expression -> expression AND expression','expression',3,'p_expression_logic','parser.py',37),
  ('expression -> expression OR expression','expression',3,'p_expression_logic','parser.py',38),
  ('expression -> expression MENOR expression','expression',3,'p_expression_logic','parser.py',39),
  ('expression -> expression MENORIGUAL expression','expression',3,'p_expression_logic','parser.py',40),
  ('expression -> expression MAYOR expression','expression',3,'p_expression_logic','parser.py',41),
  ('expression -> expression MAYORIGUAL expression','expression',3,'p_expression_logic','parser.py',42),
